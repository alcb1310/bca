	...
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		if len(keys) == 0 {
			...
			for _, k := range keys {
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/views/bca/unit_cost/partials/analysistable.templ`, Line: 25, Col: 26}
				}
				...
				for _, a := range analysis[k] {
					...
					if templ_7745c5c3_Err != nil {
						return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/views/bca/unit_cost/partials/analysistable.templ`, Line: 30, Col: 26}
					}
					...
					if templ_7745c5c3_Err != nil {
						return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/views/bca/unit_cost/partials/analysistable.templ`, Line: 31, Col: 54}
					}
