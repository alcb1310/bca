		...
		if len(keys) == 0 {
			...
			for _, k := range keys {
				...
				for _, a := range analysis[k] {
					...
					if templ_7745c5c3_Err != nil {
						return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/views/bca/unit_cost/partials/analysistable.templ`, Line: 27, Col: 34}
					}
					...
					if templ_7745c5c3_Err != nil {
						return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/views/bca/unit_cost/partials/analysistable.templ`, Line: 28, Col: 62}
					}
