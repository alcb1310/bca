...
func AnalysisTable(analysis []types.AnalysisReport) templ.Component {
	return templ.ComponentFunc(func(ctx context.Context, templ_7745c5c3_W io.Writer) (templ_7745c5c3_Err error) {
		...
		_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString("<table><thead><tr><td width=\"300px\">Categoría</td><td width=\"400px\">Material</td><td width=\"250px\">Cantidad</td></tr></thead> <tbody>")
		...
		if len(analysis) == 0 {
			...
			for _, a := range analysis {
				...
				templ_7745c5c3_Var2, templ_7745c5c3_Err = templ.JoinStringErrs(a.CategoryName)
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/views/bca/unit_cost/partials/analysistable.templ`, Line: 22, Col: 32}
				}
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/views/bca/unit_cost/partials/analysistable.templ`, Line: 24, Col: 60}
				}
